...
//   positionAmt: 7
//   amount: 10 (toFixed 3)
function saveOrderLog(mergedOrder, chainId) {
    const { orderId, symbol, side, origQty, currPrice, prevPrice, percentChange, amount, positionAmt, isFirstOrder, quantityPrecision, } = mergedOrder;
...
function saveErrorLog(err) {
    if (err instanceof Error) {
        const content = (0, error_handler_ultil_1.errorToString)(err);
...
exports.default = { saveOrderLog, saveTickLog, saveErrorLog };
