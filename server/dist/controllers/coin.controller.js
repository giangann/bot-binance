...
async function updatePriceTable(isTestnet) {
    const coinService = new coin_price_1am_service_1.default(isTestnet);
    // fetch data api
    ...
    // insert data
    const mergePrices = (0, helper_1.mergeTicerPriceAndMarketPriceBySymbol)(symbolTickerPrices, symbolMarkPrices);
